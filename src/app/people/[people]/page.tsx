    ...
    useEffect(() => {
        if (pathname === 'iroha') {
            ...
            setContents([
                ...
                { name: "あつこ", image: "atsuko", content: "いろはさん、1年間お世話になりました。いつも優しく声をかけてくれてすごく嬉しかったです。ファッションも可愛くて、オシャレで、こんな素敵な人が自分の先輩なのがすごく誇らしかったです。新規の面倒を沢山見てくれてありがとうございました！"},
            ])
            ...
            setContents([
                ...
                { name: "あつこ", image: "atsuko", content: "しょうさん、1年間お世話になりました。1年間web部門を引っ張ってくれてありがとうございました！Webのこと以外にも履修についても沢山教えてくれてすごく感謝してます！沢山迷惑をかけたと思いますが、しょうさんが部門長で嬉しかったです！" },
            ])
            ...
            setContents([
                ...
                { name: "あつこ", image: "atsuko", content: "ゆうだいさん、1年間お世話になりました。いつもweb部門を明るくしてくれてありがとうございました！ゆうだいさんが沢山話しかけてくれて嬉しかったです。新規の面倒を沢山見てくれてありがとうございました！今度パチスロ教えてください！" },
            ])
            ...
            setContents([
                ...
                { name: "あつこ", image: "atsuko", content: "みゆうさん、1年間お世話になりました。話しかけるといつも笑顔でお話してくれて、すごく嬉しかったです。持ち物がいつもカラフルで可愛くて、オシャレなみゆうさんにいつも憧れてました。新規の面倒を沢山見てくれてありがとうございました！" },
            ])
        }
    }, [pathname])
    return (
